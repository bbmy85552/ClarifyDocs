...
COMMENT ON COLUMN documents.author_id IS '作者ID - 外键关联users表';
...
('admin', 'admin@example.com', '$2b$10$example.hash.here.replace.in.production', 'admin'),
('author1', 'author1@example.com', '$2b$10$example.hash.here.replace.in.production', 'author')
